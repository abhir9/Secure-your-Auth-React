  ...
  return (
    <div className="home-container">
        ...
        <div className="home-container14">
          <div className="home-container15">
            ...
            <h3 className="home-text22 HeadingTwo">
              <span className="home-text23">Accounts from threats</span>
              <br></br>
            </h3>
      ...
      <section className="home-contaier3">
        <h1 className="home-text28 HeadingOne">Pricing</h1>
        ...
        <div className="home-container18">
          <div className="home-container19">
            <strong className="home-text30">PAY-AS-YOU-GO</strong>
            ...
            <div className="home-container21">
              <div className="home-container22">
                <div className="home-container23">
                  ...
                  <h4 className="home-text37">Free for 1 user</h4>
                </div>
                <div className="home-container24">
                  <svg viewBox="0 0 1024 1024" className="home-icon08">
                    <path d="M426 726l384-384-60-62-324 324-152-152-60 60zM512 86q176 0 301 125t125 301-125 301-301 125-301-125-125-301 125-301 301-125z"></path>
                  </svg>
                  <h4 className="home-text38">Free for 1 user</h4>
                </div>
                <div className="home-container25">
                  <svg viewBox="0 0 1024 1024" className="home-icon10">
                    <path d="M426 726l384-384-60-62-324 324-152-152-60 60zM512 86q176 0 301 125t125 301-125 301-301 125-301-125-125-301 125-301 301-125z"></path>
                  </svg>
                  <h4 className="home-text39">Free for 1 user</h4>
                </div>
